...
class Ui_proc_window(object):
    def setupUi(self, proc_window):
        ...
        proc_window.resize(937, 362)
        self.table_proc = QtWidgets.QTableWidget(proc_window)
        self.table_proc.setGeometry(QtCore.QRect(10, 10, 621, 341))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(640, 10, 281, 41))
        ...
        self.add_button.setGeometry(QtCore.QRect(640, 290, 271, 31))
        self.add_button.setObjectName("add_button")
        self.remove_button = QtWidgets.QPushButton(proc_window)
        self.remove_button.setGeometry(QtCore.QRect(640, 320, 131, 31))
        self.remove_button.setObjectName("remove_button")
        self.back_button = QtWidgets.QPushButton(proc_window)
        self.back_button.setGeometry(QtCore.QRect(780, 320, 131, 31))
        self.back_button.setObjectName("back_button")
        self.formLayoutWidget = QtWidgets.QWidget(proc_window)
        self.formLayoutWidget.setGeometry(QtCore.QRect(640, 120, 271, 100))
        ...
        self.Maid = QtWidgets.QComboBox(self.formLayoutWidget)
        self.Maid.setObjectName("Maid")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.Maid)
        self.label_4 = QtWidgets.QLabel(proc_window)
        self.label_4.setGeometry(QtCore.QRect(730, 90, 91, 16))
        self.label_4.setObjectName("label_4")
        self.line = QtWidgets.QFrame(proc_window)
        self.line.setGeometry(QtCore.QRect(647, 60, 271, 20))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(proc_window)
        self.line_2.setGeometry(QtCore.QRect(640, 250, 271, 16))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.report_button = QtWidgets.QPushButton(proc_window)
        self.report_button.setGeometry(QtCore.QRect(640, 260, 271, 31))
